...
background(friends);
  ...
  mustache = loadImage("tashnew.png");
...
void draw() {
  ...
  PImage friends = loadImage("Face.jpg");
if(mousePressed){background(friends);image(mustache,mouseX-100,mouseY-10);}
...
//image(mustache,mouseX,mouseY);
  ...
  if(mouseButton==RIGHT){background(friends);image(hat,mouseX-200,mouseY-200);}
}
